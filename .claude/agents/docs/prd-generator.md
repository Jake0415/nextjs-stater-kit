...
- **데이터 요구사항**: 읽기(어떤 데이터를 표시하는지) + 쓰기(어떤 데이터를 생성/수정하는지)
...
> **구현 기능:** `F001`, `F002` | **Figma:** [Figma URL 또는 "미정"]
...
| **데이터 요구사항** | • 읽기: [어떤 데이터를 표시하는지]<br>• 쓰기: [어떤 데이터를 생성/수정하는지] |
...
> **구현 기능:** `F003`, `F004` | **Figma:** [Figma URL 또는 "미정"]
